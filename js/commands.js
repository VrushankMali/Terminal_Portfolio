...
const projects = [
    ...
    "<br>",
    'Gardener\'s Best Friend        <a class="link" href="' + gbs + '" target="_blank">github/GardenersBestFriend</a><br>',
    'Music World                    <a class="link" href="' + musicworld + '" target="_blank">github/Music-World</a><br>',
    'Memory Game                    <a class="link" href="' + memorygame + '" target="_blank">github/Memory_Game_Project</a><br>',
    "<br>"
];
