...
const experience = [
    ...
    "<br>",
    "<br>",
    "UT Martin Information Technology Services; Martin, TN | <span class='highlight'>Flight Crew</span>; August 2020 – May 2024<br>",
    "•	Organize events and programs for students on the main campus<br>",
    "•	Provide advice for student programing and initiatives to campus leadership<br>",
    "•	Advertise events for the student body<br>",
    "<br>",
    "<br>",
...
const help = [
    ...
    '<span class="command glow">exit</span>              <span class="description yellow">Closes the terminal</span><br>',
    "<br>"
];
